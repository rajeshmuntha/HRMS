                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e3-acc-expenses.jsp"><i class="bi bi-cash-coin"></i>Expenses</a></li>
                        ...
                        <form action="">
                            <div class="row container">
                                ...
                                <div class="col-lg-12 pt-3">
                                    <div class="row">
                                        <div class="col-6">
                                            <button type="button" class="btn btn-primary btn-block add-row" value="Add Row">Submit</button>
                                        </div>
                                        <div class="col-6">
