...
<html lang="en">
<head>
<title>SPTECHHUB | Attendance Monitoring</title>
<meta charset="utf-8">
                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    <li class="active"><a href="e3-attendance-monitoring.jsp">Attendance Monitoring</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Attendance Monitoring</h2>
                        <ul class="breadcrumb">
