                            ...
                            <li class="active">
                                ...
                                <li class="">
                                    ...
                                    <ul>
                                        ...
                                        <li class=""><a style="padding-left: 78px;" href="e3-roster-day-modify.jsp">Modify Day Wise</a></li>
                                    </ul>
                                </li>
                                <li class="active"><a href="e3-roster-weekwise.jsp">Week Wise Roster</a></li>
