                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e3-app-events.jsp"><i class="icon-calendar"></i>View Events</a></li>
                            <li class=""><a href="e3-app-holidays.jsp"><i class="icon-list"></i>View Holidays</a></li>
