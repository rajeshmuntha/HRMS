                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    <li class="active"><a style="padding-left: 78px;" href="d4-view-week-roster.jsp">Week Wise</a></li>
                                    <li class=""><a style="padding-left: 78px;" href="d4-view-month-roster.jsp">Month Wise</a></li>
                                </ul>                                
                            </li>
