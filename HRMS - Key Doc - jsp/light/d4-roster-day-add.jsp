...
<html lang="en">
<head>
<title>SPTECHHUB | DayWise add Roster</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li class="active"><a style="padding-left: 78px;" href="d4-roster-day-add.jsp">Day Wise</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Day Wise Roster</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Day Wise Roster</li>
                        </ul>
                    </div>            
                    ...
                    <ul class="header-dropdown">
                        <li>
                            <form id="navbar-search" class="search-form">                                
                                <input value="" style="width: 300px;" class="form-control" placeholder="Search by Emp ID or Name..." type="text">
                                <button type="button" class="btn btn-sm btn-default"><i class="icon-magnifier"></i></button>
                            </form> 
                        </li>
                        ...
                        <li><button type="button" class="btn btn-success btn-sm px-4"><i class="text-white bi bi-box-arrow-in-right"></i>&nbsp Approve</button></li>
                    </ul>
                </div>
                <div>.</div>
                <div class="table-responsive">
                    <table id="faqs" class="table table-sm table-bordered table-hover">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th class="pe-0">Doctor ID</th>
                                <th class="pe-0">Doctor Name</th>
                                <th class="pe-0">Date</th>
                                <th style="padding-right: 0px; width: 150px;" class="pe-0">Select Branch</th>
                                <th class="pe-0">In-Time</th>
                                <th style="padding-right: 0px;" class="pe-0">Out-Time</th>
                                <th class="pe-0">Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <td><input style="width: 100px;" type="text" class="form-control" value="R02266"></td>
                                <td><input style="width: 170px;" type="text" class="form-control" value="Dr. Rajesh Muntha"></td>
                                <td><input type="date" class="form-control" value="06/04/2022"></td>
                                <td>
                                    <select class="form-control">
                                        <option">Select Branch</option>
                                        <option selected>Rawang Tin</option>
                            ...
                            <tr>
                                <td><input style="width: 100px;" type="text" class="form-control" value="R02299"></td>
                                <td><input style="width: 170px;" type="text" class="form-control" value="Srinath Kollipakula"></td>
                                <td><input type="date" class="form-control" value="09/04/2022"></td>
                                <td>
                                    <select class="form-control">
                                        <option">Select Branch</option>
                                        <option >Rawang Tin</option>
                                        <option selected>Rawang Mutiara</option>
                                        <option>Three</option>
                                    </select>
                                </td>
                                <td><input type="time" value="00:00" class="form-control"></td>
                                <td><input type="time" value="00:00" class="form-control"></td>
                                <td class="mt-10"><button class="badge badge-danger"><i class="fa fa-trash"></i> Delete</button></td>
                            </tr>
                            <tr>
                                <td><input style="width: 100px;" type="text" class="form-control" value="R02288"></td>
                                <td><input style="width: 170px;" type="text" class="form-control" value="Manikanth Gontla"></td>
                                <td><input type="date" class="form-control" value="07/04/2022"></td>
                                <td>
                                    <select class="form-control">
                                        <option">Select Branch</option>
                                        <option >Rawang Tin</option>
                                ...
                                <td><input type="time" value="09:00" class="form-control"></td>
                                <td><input type="time" value="14:00" class="form-control"></td>
                                <td class="mt-10"><button class="badge badge-danger"><i class="fa fa-trash"></i> Delete</button></td>
                            </tr>
                        </tbody>
                    </table>
...
<script src="assets/js/differenceHours.js"></script>
<!-- time calc eds -->
...
html = '<tr id="faqs-row' + faqs_row + '">';
    html += '<td><input style="width:100px;" type="text" class="form-control" placeholder="Doctor ID"></td>';
    html += '<td><input style="width:170px;" type="text" placeholder="Doctor Name" class="form-control"></td>';
    html += '<td><input type="date" class="form-control"></td>';
    html += '<td><select class="form-control"><option value="">Select Branch</option><option value="">Rawang Tin</option><option value="">Rawang Mutiara</option><option value="">Three</option><option value="">Four</option></select></td>';
