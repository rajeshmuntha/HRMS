...
<html lang="en">
<head>
<title>SPTECHHUB | Inbox Compose</title>
<meta charset="utf-8">
                    ...
                    <ul class="nav navbar-nav">                        
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu user-menu menu-icon animated bounceIn">
                                ...
                                <li><a href="d4-page-login.jsp"><i class="bi bi-file-lock2"></i> <span>Lock Your Screen</span></a></li>
                            </ul>
                        </li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Compose</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="d4-app-inbox.jsp">Inbox</a></li>
                            <li class="breadcrumb-item active">Compose</li>
                        </ul>
                    </div>            
                    <div class="col-lg-6 col-md-4 col-sm-12 text-right">
                        <!-- can add a row in a column -->
                    </div>
                </div>
            </div>
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="summernote">
                                Hello there,
                                <br/>
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Hic repellendus, unde, ipsa ipsum recusandae voluptates illum deserunt sapiente excepturi architecto asperiores quis cum saepe ut a minus dolores autem delectus. Quo laboriosam sunt suscipit maxime nisi corporis itaque consequuntur? Odio?</p>
                                <p>Please try <b>paste some texts</b> here</p>
                            </div>
                            <div class="m-t-30">
                                <button type="button" class="btn btn-success">Send Message</button>
                                <button type="button" class="btn btn-secondary">Draft</button>
                                <a href="d4-app-inbox.jsp" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
