                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            <li class="active"><a href="d4-emp-attendance2.jsp"><i class="bi bi-book"></i>Attendance</a></li>
                            <li class="">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> <b>Punch your Attendance</b> </h2>
                        <ul class="breadcrumb">
                     ...
                     <div class="row filter-row">
                        <div class="col-sm-3">  
                            <div class="form-group form-focus">
                                <div class="cal-icon">
                                    <input type="text" class="form-control" placeholder="Emp ID | Name" id="">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-2">
                    ...
                    <div class="row">
                        <div class="col-lg-12 pb-4">
                            <div class="table-responsive">
                                <table class="table table-striped custom-table mb-0 table-sm">
