...
<body oncontextmenu="return false;">
  <section class="bg pt-0 ">
    <div class="container pt-0">
      <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-5 col-6 tpad">
              ...
              <div class="card">
                ...
                <div class="card-front">
                     ...
                     <form class="animate pt-5 pb-4" action=""  id="test">
                      ...
                      id="psw" name="psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 6 or more characters" required>
                        ...
                        <div class="d-flex justify-content-evenly bd-highlight pt-4 pb-0">
                          <a href="d4-emp-attendance2.jsp" type="submit" value="Submit" class="btn btn-primary px-5"><b>Login <i class="bi bi-box-arrow-in-right"></i></b></a>
                    ...
                    <div class="text-center">
                      ...
                      <div class="pt-0 m-0">
                        Forgot<a href="d4-Forgot.jsp"  class="primary text-decoration-none fw-bold">Password</a>?
                      </div>
                    </div>
                </div>
