...
<html lang="en">
<head>
<title>SPTECHHUB | Add Events</title>
<meta charset="utf-8">
                ...
                <div class="tab-pane animated fadeIn flow " id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class=""><a href="d4-app-events.jsp"><i class="icon-calendar"></i>View Events</a></li>
                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="d4-add-events.jsp">Add Events</a></li>
                                </ul>
                            </li>  
                            <li class="">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Add Events</h2>
                        <ul class="breadcrumb">
