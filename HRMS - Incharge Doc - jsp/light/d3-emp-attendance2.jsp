...
<body class="theme-blue" oncontextmenu="return fale;">
                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            <li class="active"><a href="d3-emp-attendance2.jsp"><i class="bi bi-book"></i>Attendance</a></li>
                            <li class="">
                            ...
                            <div class="p-2" style="height: 365px;">
                                <div class="card p-2 mb-3 mt-0 pt-0 border">
                                    ...
                                    <div class="progress mt-3" style="height: 3px;">
                                        <div id="progressbar" class="progress-bar bg-primary" style="width: 34%;" role="progressbar" aria-valuenow="31" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="card p-2 mb-3 mt-0 pt-0 border">
