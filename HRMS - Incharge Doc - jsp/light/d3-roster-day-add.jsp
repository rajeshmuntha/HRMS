...
<link rel="icon" href="./assets/assets/imgs/favicon.png" type="image/x-icon">
<!-- VENDOR CSS -->
...
<link rel="stylesheet" href="./assets/assets/css/color_skins.css">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li class="active"><a style="padding-left: 78px;" href="d3-roster-day-add.jsp">Day Wise</a></li>
                    ...
                    <ul class="header-dropdown">
                        <li>
                            <form id="navbar-search" class="search-form">
                                <input style="width:300px" value="" class="form-control" placeholder="Search by Emp ID or Name..." type="text">
                    ...
                    <table id="faqs" class="table table-sm table-bordered table-hover">
                        <thead class="bg-primary text-white">
                            <tr>
                                ...
                                <th style="padding-right: 0px; width: 150px;" class="pe-0">Branch</th>
