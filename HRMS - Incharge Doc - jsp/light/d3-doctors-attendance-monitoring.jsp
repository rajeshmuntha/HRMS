...
<html lang="en">
<head>
<title>SPTECHHUB | Doctors Attendance Monitoring</title>
<meta charset="utf-8">
                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    <li class="active"><a href="d3-doctors-attendance-monitoring.jsp">Doctor's Attendance Monitoring</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Doctors Attendance Monitoring</li>
                        </ul>
                    </div>            
                ...
                <div class="table-responsive">
                    <table id="faqs" class="table table-sm table-bordered">
                        <div class="py-3 float-right">
                            <h6 >From &nbsp; 06-06-2022 &nbsp; to &nbsp; 12-06-2022</h6>
                        </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <tr>
                                    <td><b>Br <br> Name</b></td>
                                    <td><b>InTime <br> <span class="text-danger">Login</span></b></td>
                                    <td><b>OutTime <br> <span class="text-danger">Logout</span></b></td>
                                    <td><b>Br <br> Name</b></td>
                                    <td><b>InTime <br> <span class="text-danger">Login</span></b></td>
                                    <td><b>OutTime <br> <span class="text-danger">Logout</span></b></td>
                                    <td><b>Br <br> Name</b></td>
