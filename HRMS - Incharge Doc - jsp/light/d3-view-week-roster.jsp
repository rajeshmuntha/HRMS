                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    <li class="active"><a style="padding-left: 78px;" href="d3-view-week-roster.jsp">Week Wise</a></li>
                                    <li class=""><a style="padding-left: 78px;" href="d3-view-month-roster.jsp">Month Wise</a></li>
                                </ul>                                
                            </li>
                        ...
                        <ul class="main-menu metismenu">
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <!-- <li class=""><a href="d3-add-events.jsp">Add Events</a></li> -->
                                </ul>
                            </li> 
                            <li class="">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>View Roster</h2>
                        <ul class="breadcrumb">
                    ...
                    <div class="card bg-light p-3 m-0">
                        <div class="body">
                            <div class="row d-flex justify-content-around">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12 shadow-sm card">
                                    <div class="body">
                                            ...
                                            <table class="table table-sm table-bordered text-center">
                                                ...
                                                <tbody>
                                                    <tr class="text-danger">
                                                        ...
                                                        <td class="text-danger" rowspan="3">Monday</td>
                                                        <td>Rawang Tin</td>
                                                        <td>06:00</td>
                                                        <td>08:00</td>
                                                        <td>02 Hrs</td>
                                                    ...
                                                    <tr class="text-danger">
                                                        ...
                                                        <td class="text-danger" rowspan="3">Tuesday</td>
                                                        <td>Rawang Tin</td>
                                                        <td>06:00</td>
                                                        <td>08:00</td>
                                                        <td>02 Hrs</td>
                                                    ...
                                                    <tr class="text-danger">
                                                        ...
                                                        <td class="text-danger" rowspan="3">Wednesday</td>
                                                        <td>Rawang Tin</td>
                                                        <td>06:00</td>
                                                        <td>08:00</td>
                                                        <td>02 Hrs</td>
