                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="d3-payroll-payslip.jsp"><i class="bi bi-file-earmark-medical"></i>Payslip</a></li> 
                            ...
                            <div class="invoice-top clearfix">
                                ...
                                <div class="">
                                    <div class="clientlogo">
                                        <img src="./assets/images/d3-user.jpg" alt="user" class="rounded-circle img-fluid">
                                    </div>
                                    <div class="info">
                                        <h6>Dr. Narayana</h6>
                                        <p>Incharge Doctor<br>Employee ID: R02266</p>
                                        <!-- <div class="pb-2">
