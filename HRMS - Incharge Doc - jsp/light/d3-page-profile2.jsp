            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">                  
                        <li><a href="d3-app-events.jsp" class="icon-menu d-none d-sm-block d-md-none d-lg-block text-decoration-none"><i class="icon-calendar"></i></a></li>
                        <li><a href="d3-app-chat.jsp" class="icon-menu d-none d-sm-block text-decoration-none"><i class="icon-bubbles"></i></a></li>
                        <li><a href="d3-app-inbox.jsp" class="icon-menu d-none d-sm-block text-decoration-none"><i class="icon-envelope"></i><span class="notification-dot"></span></a></li>
                        <li class="dropdown">
                        ...
                        <li><a href="d3-page-login.jsp" class="icon-menu"><i class="icon-login"></i></a></li>                        
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="dropdown-toggle user-name text-decoration-none" data-toggle="dropdown"><strong>Dr. Narayana</strong></a>                    
                    <ul class="dropdown-menu dropdown-menu-right account animated flipInY">
                        <li class="text-decoration-none"><a href="d3-page-profile2.jsp"><i class="icon-user"></i>My Profile</a></li>
            ...
            <div class="tab-content p-l-0 p-r-0 overflow-auto">
                ...
                <div class="tab-pane animated fadeIn active" id="sub_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">                      
                            <li class="">
                                <a href="#Pages" class="has-arrow"><i class="bi bi-person"></i><span>Incharge Head</span></a>
                                <ul>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Incharge Doctor Profile</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Incharge Doctor Profile</li>
                        </ul>
                    </div>            
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card profile-header">
                        <div class="body">
                            <div class="profile-image"> <img src="../assets/images/d3-user.jpg" class="w-75 rounded-circle shadow img-fluid alt=""> </div>
                            <div>
                                <h4 class="m-b-0"><strong>Dr. Narayana</strong></h4>
                                <span class="fw-bold">Incharge Doctor</span> <br>
                                <span>Andhra Pradesh.</span>
                            </div>
                            <div class="m-t-15">
                                <button class="btn btn-primary px-4">Follow</button>
                                <a href="d3-app-chat.jsp"><button class="btn btn-outline-secondary">Message</button></a>
                            </div>                            
                        </div>
                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    ...
                                                                    <input type="text" class="form-control" value="Narayana" disabled placeholder="First Name">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    <label for="">Last Name</label>                                              
                                                                    <input type="text" class="form-control" value="Swamy" disabled placeholder="Last Name">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">   
