                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <li class="active"><a href="d3-roster-weekwise.jsp">Week Wise Roster</a></li>
                    ...
                    <table id="faqs" class="table table-sm table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <tr>
                                    <!-- <th>Week</th> -->
                                    <td colspan="4" class="bg-primary text-white border text-center">Monday</td>
                                    <td colspan="4" class="bg-success text-white border text-center">Tuesday</td>
                                    <td colspan="4" class="bg-danger text-white border text-center">Wednesday</td>
                                    <td colspan="4" class="bg-info text-white border text-center">Thursaday</td>
                                    <td colspan="4" class="bg-warning text-white border text-center">Friday</td>
                                    <td colspan="4" class="bg-dark text-white border text-center">Saturday</td>
                                    <td colspan="4" class="bg-secondary text-white border text-center">Sunday</td>
                                </tr>
                                <tr>
                                    <!-- <td rowspan="3"><b>Br Name <br> InTime <br> OutTime</b></td> -->
                                    <td colspan="2" class="border">RT</td>
                                ...
                                <tr>
                                    <td colspan="2" class="border">AG</td>
                                    <td class="border">06:00</td>
                                    <td class="border">12:00</td>
                                    <td colspan="2" class="border">AG</td>
                                    <td class="border">06:00</td>
                                ...
                                <tr>
                                    <td colspan="2" class="border">RM</td>
                                    <td class="border">06:00</td>
                                    <td class="border">12:00</td>
                                    <td colspan="2" class="border">RM</td>
                                    <td class="border">06:00</td>
