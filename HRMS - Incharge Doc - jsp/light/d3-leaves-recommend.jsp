    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="d3-page-profile2.jsp"><img src="../assets/images/logo.png" alt="SPTECHHUB Logo" class="img-responsive logo"></a>                
            </div>
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="d3-leaves-recommend.jsp">Leaves to Recommend</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Leaves to Recommend</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Leaves to Recommend</li>
                        </ul>
                    </div>            
                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0 c_list">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-sm btn-success px-3" title="Recommend">Recommend</button>
                                                <button type="button" class="btn btn-sm btn-outline-danger js-sweetalert" title="Declined" data-type="confirm">Cancel Req</button>
                                            </td>
                                        </tr>                                        
                                    </tbody>
                                </table>
