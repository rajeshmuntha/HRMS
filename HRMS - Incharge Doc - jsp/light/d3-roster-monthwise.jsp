                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="">
                                ...
                                <ul>
                                    <li class=""><a href="d3-attendance-monitoring.jsp">Attendance Monitoring</a></li>
                                    <li class=""><a href="d3-center Incharge-leave ratify.jsp">Leave's to Ratify</a></li>
                                </ul>
                            </li> 
                            <li class="active">
                                ...
                                <li class="">
                                    ...
                                    <ul>
                                        ...
                                        <li><a style="padding-left: 78px;" href="d3-roster-day-modify.jsp">Modify Day Wise</a></li>
                                        <li class=""><a href="d3-add-holidaysList.jsp">Add Holidays List</a></li>
                                    </ul>
                                </li>
                                <li class=""><a href="d3-roster-weekwise.jsp">Week Wise Roster</a></li>
                                <li class="active"><a href="d3-roster-monthwise.jsp">Month Wise Roster</a></li>
                                </ul>
                            </li> 
                        </ul>
                    </nav>
        ...
        <div class="container-fluid">
            ...
            <div class="card p-4">
                ...
                <div class="table-responsive">
                    <table id="faqs" class="table table-sm">
                        <thead>
                            <tr class="bg-warning">
                        ...
                        <tbody>
                            <tr>
                                <td><a href="" data-toggle="modal" data-target="#RajeshMuntha">R02266 <br>Dr. Rajesh Muntha</a></td>
...
<!-- model 1 launch -->  
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h6 class="modal-title" id="exampleModalCenterTitle">Attendance details of <span class="text-primary">Dr. Rajesh Muntha</span> for the month of <span class="text-primary"><b>June, 2022</b></span></h6>
  ...
  <!-- model 2 launch -->  
  <!-- Modal -->
  <div class="modal fade" id="#KrishnaMurthy" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalCenterTitle">Attendance details of <span class="text-primary">Dr. Krishna Murthy</span> for the month of <span class="text-primary"><b>June, 2022</b></span></h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">                    
                    <table class="table table-responsive table-sm table-bordered text-center">
                        ...
                        <tbody>
                            <tr class="">
                                <td rowspan="3">01-06-2022</td>
                                <td class="" rowspan="3">Wednesday</td>
                                <td>RT</td>
                                <td>06:00</td>
                                <td>08:00</td>
                                <td>02 Hrs</td>
                                <td rowspan="3">12 Hours</td>
                            </tr>
                            <tr class="">
                                <td>AG</td>
                                <td>09:00</td>
                            ...
                            <tr class="">
                                <td rowspan="3">02-06-2022</td>
                                <td class="" rowspan="3">Thursday</td>
                                <td>RT</td>
                                <td>06:00</td>
                                <td>08:00</td>
                                <td>02 Hrs</td>
                                <td rowspan="3">11 Hours</td>
                            </tr>
                            <tr class="">
                                <td>AG</td>
                                <td>09:00</td>
                            ...
                            <tr class="">
                                <td rowspan="3">03-06-2022</td>
                                <td class="" rowspan="3">Friday</td>
                                <td>RT</td>
                                <td>06:00</td>
                                <td>08:00</td>
                                <td>02 Hrs</td>
                                <td rowspan="3">14 Hours</td>
                            </tr>
                            <tr class="">
                                <td>AG</td>
                                <td>09:00</td>
                            ...
                            <tr>
                                <td rowspan="3">06-06-2022</td>
                                <td class="" rowspan="3">Monday</td>
                                <td>RT</td>
                                <td>06:00</td>
                                <td>08:00</td>
                                <td>02 Hrs</td>
                            ...
                            <tr>
                                <td rowspan="3">07-06-2022</td>
                                <td class="" rowspan="3">Tuesday</td>
                                <td>RT</td>
                                <td>06:00</td>
                                <td>08:00</td>
                                <td>02 Hrs</td>
                            ...
                            <tr>
                                <td rowspan="3">11-06-2022</td>
                                <td class="" rowspan="3">Saturday</td>
                                <td>RT</td>
                                <td>06:00</td>
                                <td>08:00</td>
                                <td>02 Hrs</td>
                            ...
                            <tr>
                                <td rowspan="3">12-06-2022</td>
                                <td class="" rowspan="3">Sunday</td>
                                <td>RT</td>
                                <td>06:00</td>
                                <td>08:00</td>
                                <td>02 Hrs</td>
