                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="d3-staff-attendance-monitoring.jsp">Staff Attendance Monitoring</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Staff Attendance Monitoring</h2>
                        <ul class="breadcrumb">
