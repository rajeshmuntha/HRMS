        ...
        <div class="col-lg-12 ">
          ...
          <div class="row shadow-lg">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 left-side">
              ...
              <div class="propic">
                <img class="img-fluid rounded-circle" src="../assets/images/e2-user-small.jpg" alt="">
              </div>
              ...
              <form action="">
                ...
                <div class="pt-3">
                  <button href="e2-emp-attendance2.jsp" type="submit" class="btn btn-success">Unlock - <i class="bi bi-unlock"></i></button>
                </div>
              </form>
              <hr>
              <a href="e2-page-login.jsp" class="text-decoration-none">Logout <i class="bi bi-box-arrow-right"></i></a>
            </div>
          </div>
      </div>
    </div>
