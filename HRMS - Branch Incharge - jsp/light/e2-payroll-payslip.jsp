                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e2-payroll-payslip.jsp"><i class="bi bi-file-earmark-medical"></i>Payslip</a></li> 
                            <li class=""><a href="acc-expenses.jsp"><i class="bi bi-cash-coin"></i>Expenses</a></li>
                            ...
                            <div class="invoice-top clearfix">
                                ...
                                <div class="">
                                    <div class="clientlogo">
                                        <img src="../assets/images/e2-user.jpg" alt="user" class="rounded-circle img-fluid">
                                    </div>
                                    <div class="info">
                                        <h6>Kali Rao</h6>
