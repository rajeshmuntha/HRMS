...
<html lang="en">
<head>
<title>SPTECHHUB | Chat App</title>
<meta charset="utf-8">
...
<div id="wrapper">
                ...
                <div class="tab-pane animated fadeIn active" id="project_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="e2-app-chat.jsp"><i class="icon-bubbles"></i>Chat App</a></li>
    ...
    <div id="main-content">
        <div class="container-fluid">
            ...
            <div style="margin-left: 1px;" class="card row clearfix">
                <div class="col-lg-12">
                    <div style="padding: 150px 0;" class="row text-center">
                        <div class="col-lg-12">
                            <div>
                                <p class="grad1">Coming Soon</p>
                                <p class="para">This page is under construction.</p>
