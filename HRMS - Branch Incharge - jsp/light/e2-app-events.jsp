...
<html lang="en">
<head>
<title>SPTECHHUB | View Events</title>
<meta charset="utf-8">
...
<body class="theme-blue page-calendar" oncontextmenu="return false;">
                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e2-app-events.jsp"><i class="icon-calendar"></i>View Events</a></li>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>View Events</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    <!-- <div style="background-color: rgba(241, 248, 255, 0.699);" class="card shadow"> -->
