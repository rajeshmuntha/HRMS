...
<html lang="en">
<head>
<title>SPTECHHUB | Branch Incharge Profile</title>
<meta charset="utf-8">
            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">                  
                        <li><a href="e2-app-events.jsp" class="icon-menu d-none d-sm-block d-md-none d-lg-block text-decoration-none"><i class="icon-calendar"></i></a></li>
                        <li><a href="e2-app-chat.jsp" class="icon-menu d-none d-sm-block text-decoration-none"><i class="icon-bubbles"></i></a></li>
                        <li><a href="e2-app-inbox.jsp" class="icon-menu d-none d-sm-block text-decoration-none"><i class="icon-envelope"></i><span class="notification-dot"></span></a></li>
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu user-menu menu-icon animated bounceIn text-decoration-none">
                                ...
                                <li><a href="e2-page-login.jsp"><i class="bi bi-file-lock2"></i> <span>Lock Your Screen</span></a></li>
                            </ul>
                        </li>
                        <li><a href="e2-page-lockscreen.jsp" class="icon-menu"><i class="icon-login"></i></a></li>                        
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="dropdown-toggle user-name text-decoration-none" data-toggle="dropdown"><strong>Kali Rao</strong></a>                    
                    <ul class="dropdown-menu dropdown-menu-right account animated flipInY">
                        <li class="text-decoration-none"><a href="e2-page-profile2.jsp"><i class="icon-user"></i>My Profile</a></li>
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card profile-header">
                        <div class="body">
                            <div class="profile-image"> <img src="../assets/images/e2-user.jpg" class="w-75 rounded-circle shadow img-fluid alt=""> </div>
                            <div>
                                <h4 class="m-b-0"><strong>Kali</strong> Rao</h4>
                                <span class="fw-bold">Administrator</span> <br>
                                <span>Andhra Pradesh.</span>
                            </div>
                            <div class="m-t-15">
                                <button class="btn btn-primary px-4">Follow</button>
                                <a href="app-chat.jsp"><button class="btn btn-outline-secondary">Message</button></a>
                            </div>                            
                        </div>
                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    ...
                                                                    <input type="text" class="form-control" value="Kali" disabled placeholder="First Name">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    <label for="">Last Name</label>                     
                                                                    <input type="text" class="form-control" value="Rao" disabled placeholder="Last Name">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">   
                                                                    <label for="">Username</label>                                             
                                                                    <input type="text" class="form-control" value="kalirao23" disabled placeholder="Username">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    <label for="">Email ID</label>                                              
                                                                    <input type="email" class="form-control" value="kalirao23@gmail.com" disabled placeholder="Email id">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group"> 
...
<script src="vendor/summernote/dist/profile-wordpad.js"></script>
