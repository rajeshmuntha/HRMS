        ...
        <div class="col-lg-12 ">
          ...
          <div class="row shadow-lg">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 left-side">
              ...
              <div class=" propic">
                <img class="img-fluid rounded-circle" src="../assets/images/g-user-small.jpeg" alt="">
              </div>
              ...
              <form action="">
                ...
                <div class="pt-3">
                  <button href="g-welcome.jsp" type="submit" class="btn btn-success">Unlock - <i class="bi bi-unlock"></i></button>
                </div>
              </form>
              <hr>
              <a href="g-page-login.jsp" class="text-decoration-none">Logout <i class="bi bi-box-arrow-right"></i></a>
            </div>
          </div>
      </div>
    </div>
