...
<html lang="en">
<head>
<title>SPTECHHUB | Staff Month Wise Attendance Monitoring</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="">
                                ...
                                <ul>
                                    ...
                                    <li class=""><a style="padding-left: 78px;" href="e4-view-month-roster.jsp">Month Wise</a></li>
                                </ul>                                
                            </li>
                                ...
                                <ul>
                                    ...
                                    <li style="text-decoration: none;" class="active">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a style="padding-left: 78px;" href="e4-staff-month-attendance-monitoring.jsp">Month Wise</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Staff Month Wise Attendance Monitoring</h2>
                        <ul class="breadcrumb">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-12">  
                                    <table class="table-responsive table table-hover table-sm">
                                        <tr class="border">
                                            ...
                                            <td><select style="width: 150px;" class="form-control form-control-sm text-primary">
                                                <option>Choose Emp ID</option>
                                                <option>R02266</option>
                                                <option>R02267</option>
                                                <option>R02268</option>
                                            </select>
                                            </td>
                                        </tr>
