                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <li class="active">
                                    ...
                                    <ul>
                                        <li class="active"><a style="padding-left: 78px;" href="e4-roster-day-add.jsp">Day Wise</a></li>
...
html = '<tr id="faqs-row' + faqs_row + '">';
    html += '<td><input style="width: 100px;" type="text" class="form-control" placeholder="Emp ID"></td>';
    html += '<td><input style="width: 170px;" type="text" placeholder="Username" class="form-control"></td>';
