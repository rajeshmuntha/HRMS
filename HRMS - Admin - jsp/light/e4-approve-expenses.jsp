...
<html lang="en">
<head>
<title>SPTECHHUB | Expenses to Approve</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="e4-approve-expenses.jsp">Expenses to Approve</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Expenses to Approve</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Expenses to Approve</li>
                        </ul>
                    </div>            
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                ...
                                <li><button type="button" class="btn btn-success">Approve</button></li>
