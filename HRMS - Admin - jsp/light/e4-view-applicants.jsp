...
<html lang="en">
<head>
<title>SPTECHHUB | View Applicants</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="e4-view-applicants.jsp">View Applicants</a></li>
                                </ul>
                            </li>
                            <li class="">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>View Applicants</h2>
                        <ul class="breadcrumb">
                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0 c_list">
                                    ...
                                    <tbody>
                                        <tr style="height: 100px;" class="text-center">
                                            ...
                                            <td>BSc Pharmacy</td>
                                            <td>4 years</td>
                                            <td class="text-wrap" style="width: 500px; height: 100px; overflow: auto; text-align: justify; text-justify: inter-word;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt similique, numquam, at dolorum<span id="dots">...</span><span id="more">assumenda repellendus amet aut sit recusandae est quaerat aliquam, nihil dolore veniam provident facilis eius ut maxime earum! Dolorum atque eligendi natus? Unde corrupti repellendus provident, facilis dicta fugiat, voluptates consequatur accusamus enim vero fuga quos repudiandae ipsa sunt amet delectus, iusto labore qui tempora eaque inventore? Hic quia unde temporibus corporis suscipit! Voluptates aliam.</span>
                                            <a style="cursor: pointer;" class="text-primary" onclick="myFunction()" id="myBtn">Read more</a>
                                            </td>
                                            <td><img id="myImg" src="./assets/assets/imgs/bg2.png" alt="imgs" width="100" height="50"></td>
                                        </tr>
                                    </tbody>
                                </table> <br>
                            </div>
