...
<html lang="en">
<head>
<title>SPTECHHUB | Add Branch</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="e4-add-branch.jsp">Add Branch</a></li>
            ...
            <div class="card p-1">
                <div class="header">
                    ...
                    <ul class="header-dropdown">
                        <li><button class="btn btn-info btn-sm" data-toggle="modal" data-target="#Leave_Request">Add New Branch</button></li>
                        <li><button type="button" class="btn btn-secondary btn-sm delete-row">Delete</button></li>
                    </ul>
                </div>
                <div class="body">
                        ...
                        <table class="table table-hover border">
                            <thead class="bg-primary text-white">
                                <tr class="">
                                    ...
                                    <th style="text-align: center; vertical-align: middle;">C_SName</th>
                                    <th style="text-align: center; vertical-align: middle;">C_LName</th>
                                    <th style="text-align: center; vertical-align: middle;">C_Address</th>
                                    <th style="text-align: center; vertical-align: middle;">C_Pincode</th>
                                    <th style="text-align: center; vertical-align: middle;">C_Latitude</th>
                                    <th style="text-align: center; vertical-align: middle;">C_Longitude</th>
                                    <th style="text-align: center; vertical-align: middle;">Select & <br> Delete</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-wrap" style="width: 15rem; text-align: justify;">Lorem ipsum dolor sit amet consectetur adipisicing elit, maxime. Malaysia</td>
                                    <td class="text-center">522201</td>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel">Add New Branch</h6>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="C_Config_ID" placeholder="Serial Number">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="C_SName" placeholder="Centre Short Name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="C_LName" placeholder="Centre Long Name">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <!-- <input type="text" class="form-control" id="C_Address" placeholder="Centre Address"> -->
                                <textarea class="form-control" name="" id="C_Address" placeholder="Start typing Address here..."></textarea>
                            </div>
                        </div>

                        <div class="col-md-4">
                            <div class="form-group">
                                <input type="text" class="form-control" id="C_Pincode" placeholder="Centre Pincode">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="C_Latitude" placeholder="Centre Latitude">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" class="form-control" id="C_Longitude" placeholder="Centre Longitude">
                            </div>
                        </div>
...
<script type="text/javascript" language="javascript">
    $(document).ready(function(){
            $(".add-row").click(function(){ 
                var C_Config_ID = $("#C_Config_ID").val();
                var C_SName = $("#C_SName").val();           
                var C_LName = $("#C_LName").val();
                var C_Address = $("#C_Address").val();
                var C_Pincode = $("#C_Pincode").val(); 
                var C_Latitude = $("#C_Latitude").val();
                var C_Longitude = $("#C_Longitude").val();   
                var markup = "<tr><td style='text-align:center;'>" + C_Config_ID + "</td><td style='text-align:center;'>" + C_SName + "</td><td style='text-align:center;'>" + C_LName + "</td><td class='text-wrap' style=' text-align: justify;'>" + C_Address + "</td><td style='text-align:center;'>" + C_Pincode + "</td><td style='text-align:center;'>" + C_Latitude + "</td><td style='text-align:center;'>" + C_Longitude + "</td><td style='text-align:center;'><input type='checkbox' name='record'></td></tr>";
