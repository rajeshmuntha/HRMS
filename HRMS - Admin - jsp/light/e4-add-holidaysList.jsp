...
<html lang="en">
<head>
<title>SPTECHHUB | Add Holidays List</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="e4-add-holidaysList.jsp">Add Holidays List</a></li>
                                </ul>
                            </li> 
                            <li class="">
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Add Holidays List</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Add Holidays List</li>
                        </ul>
                    </div>            
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown">
                                <li><button class="btn btn-info btn-sm" data-toggle="modal" data-target="#Leave_Request">Add Holiday</button></li>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel">Add Holiday List</h6>
            ...
            <div class="modal-body">
                <form action="">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="text" data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="To Date" data-date-format="dd-mm-yyyy" id="date" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">                                
                                <input type="text" class="form-control" id="holidayname" placeholder="Holiday Name">
                            </div>
                        </div>
                        <div class="col-6">
...
$(document).ready(function(){
        $(".add-row").click(function(){ 
            ...
            var markup = "<tr><td>" + countryname + "</td><td>" + statename + "</td><td>" + day + "</td><td>" + date + "</td><td>" + holidayname + "</td><td><input type='checkbox' class='text-center' name='record'></td></tr>";
