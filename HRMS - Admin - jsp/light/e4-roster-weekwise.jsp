                            ...
                            <li class="active">
                                ...
                                <li class="">
                                    ...
                                    <ul>
                                        ...
                                        <li class=""><a style="padding-left: 78px;" href="e4-roster-day-modify.jsp">Modify Day Wise</a></li>
                                    </ul>
                                </li>
                                <li class="active"><a href="e4-roster-weekwise.jsp">Week Wise Roster</a></li>
                ...
                <div class="table-responsive">
                    <table id="faqs" class="table table-sm table-hover">
                        <thead class="bg-primary text-white">
                            <tr>
                                <th colspan="16">Emp ID <br> Emp Name</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
