            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card profile-header">
                        <div class="body">
                            <div class="profile-image"> <img src="../assets/images/e4-user.jpg" class="w-75 rounded-circle shadow img-fluid alt=""> </div>
                            <div>
                                <h4 class="m-b-0"><strong>Rajasekhar</strong> Rao</h4>
                                <span class="fw-bold">IT Manager </span> <br>
                                <span>Andhra Pradesh.</span>
                            </div>
                            <div class="m-t-15">
                                <button class="btn btn-primary px-4">Follow</button>
                                <a href="e4-app-chat.jsp"><button class="btn btn-outline-secondary">Message</button></a>
                            </div>                            
                        </div>
                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    ...
                                                                    <input type="text" class="form-control" value="Rajasekhar" disabled placeholder="First Name">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">   
                                                                    ...
                                                                    <input type="text" class="form-control" value="rajasekhar66" disabled placeholder="Username">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    <label for="">Email ID</label>                                              
                                                                    <input type="email" class="form-control" value="rajasekhar66@gmail.com" disabled placeholder="Email id">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group"> 
