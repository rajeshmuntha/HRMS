...
<html lang="en">
<head>
<title>SPTECHHUB | Apply Leave</title>
<meta charset="utf-8">
                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e4-emp-leave.jsp"><i class="bi bi-pencil-square"></i>Apply Leave</a></li>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <div id="toast" class="animate__animated animate__heartBeat text-primary" data-delay="5000">
                                    ...
                                    <br>
                                    Your Leave is Successfully Submitted.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form action="">
                    <div class="row clearfix">
                        ...
                        <div class="col-6">
                            <button type="button" class="btn btn-primary btn-block add-row"  data-dismiss="modal" onclick="toastFunction()">Add</button>
                        </div>   
