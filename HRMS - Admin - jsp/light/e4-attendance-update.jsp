...
<html lang="en">
<head>
<title>SPTECHHUB | Attendance Update</title>
<meta charset="utf-8">
...
<div id="wrapper">
                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="e4-attendance-update.jsp">Attendance Update</a></li>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Update Punch-Out Attendance</h2>
                        <ul class="breadcrumb">
            ...
            <div class="card p-1">
                <div class="body">
                    <div style="border-radius: 20px;" class="row py-4">  
                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                            ...
                            <table class="table table-responsive table-sm table-hover pt-2">
                                ...
                                <tr>
                                    <th>Mobile No:</th>
                                    <td>+91 9123 45 6789</td>
                                    <th style="vertical-align: middle;">Email ID</th>
                                    <td>testing@spcare.com</td>
                                </tr>
                            </table>
                        </div>
                        <!-- <div class="d-none d-sm-none d-md-block col-lg-1 col-md-1">
                            <div style="background-color: #189cdf; height: 170px; width: 3px;" class=""></div>
                        </div> -->
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                            <label for="">Configure <span class="text-primary">Punch-In Time:-</span> </label>
                            <input type="date" date-format="dd-mm-yyyy" class="form-control" id="txtName">
                            <input type="button" class="btn btn-primary btn-sm btn-block mt-2" id="btnCopy" value="Click to Print Date & Time" onclick = "CopyToLabel()" />
                            <hr>
                            <h6 class="mt-0">Punch-In Date/Time: -</h6>
                            <div class="text-primary" style="font-weight: 500;"><span id = "lblName"></span>/00:00</div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                            <label for="">Configure <span class="text-primary">Punch-Out Time:-</span> </label>
                            <input type="datetime-local" class="form-control" name="" id="">
                            <div class=" pt-3">
                                <button type="submit" class="btn btn-success btn-block btn-lg px-5" onclick="toastFunction()"><i class="bi bi-save"></i> Click to Update Attendance</button>
                            </div>                              
                        </div> 
                    </div>
                    <!-- toast on submit -->
                    <div  id="toast" class="text-primary" data-delay="5000" >
                        ...
                        <br>
                       Employee's <span class="text-success">Punch-Out has updated Successfully!.</span> 
                    </div>
                </div>
            </div>            
        </div>  
...
// PunchIn Date print from Picker -starts
...
// PunchIn Date print from Picker -ends
