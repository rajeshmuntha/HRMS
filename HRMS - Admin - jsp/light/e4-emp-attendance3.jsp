                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            <li class="active"><a href="e4-emp-attendance2.jsp"><i class="bi bi-book"></i>Attendance</a></li>
                            <li class="">
                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="">
                                ...
                                <ul>
                                    <li class=""><a href="e4-doctors-attendance-monitoring.jsp">Doctor's Attendance Monitoring</a></li>
