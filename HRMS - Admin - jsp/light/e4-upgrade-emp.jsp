...
<html lang="en">
<head>
<title>SPTECHHUB | Upgrade Employee</title>
<meta charset="utf-8">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-right">
                <form id="navbar-search" class="navbar-form search-form">
                    ...
                    <button type="button" class="btn btn-default"><i class="text-primary icon-magnifier"></i></button>
                </form>                
        ...
        <div class="sidebar-scroll">
            ...
            <div class="tab-content p-l-0 p-r-0">
                ...
                <div class="tab-pane animated fadeIn flow active" id="sub_menu">
                    <nav class="sidebar-nav overflow-auto">
                        <ul class="main-menu metismenu overflow-auto">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="e4-upgrade-emp.jsp">Upgrade Employee</a></li> 
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Upgrade Employee</h2>
                        <ul class="breadcrumb">
                ...
                <div class="col-lg-12">
                    <div class="card"> 
                        <div class="header float-right">
                            <button type="submit" class="btn btn-success"><i class="text-white bi bi-box-arrow-in-right"></i> Confirm</button>
                        </div>                       
                        <div class="body">
                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom">
                                    <thead class="bg-primary text-white">
                                        <tr>
                                            ...
                                            <th>Employee ID</th>
                                            <th>Probation Confirmation Date</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>R02266</td>
                                            <td class="">
                                                <input style="width: 100px;" id="" data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="DOJ" data-date-format="dd-mm-yyyy"> 
                                            </td> 
                                            <td>                                                
                                                <form action="">
                                                    <input style="width: 100px;" type="text" class="form-control" placeholder="Dr0406" pattern="([D][r])\w+[0-9]|([P][0])\w+[0-9]|([R][0])\w+[0-9]" required title="Doctor: Dr1010 Or Permanent Emp: P02636 Or Regular Emp: R03696">
                                        ...
                                        <tr>
                                            <td>Kranthi</td>
                                            <td>Kumar</td>
                                            <td>kranthikumar05</td>
                                            <td>kranthi1994@gmail.com</td>
