...
<html lang="en">
<head>
<title>SPTECHHUB | Doctors Week Attendance Monitoring</title>
<meta charset="utf-8">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu user-menu menu-icon animated bounceIn">
                                ...
                                <li class=""><a href="e4-page-profile2.jsp"><i class="bi bi-person-square"></i> <span>Profile</span></a></li>
                                <li><a href="e4-page-lockscreen.jsp"><i class="bi bi-file-lock2"></i> <span>Lock Your Screen</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="e4-page-login.jsp" class="icon-menu"><i class="icon-login"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    <li class="active">
                                        ...
                                        <ul>
                                            <li class="active"><a style="padding-left: 78px;" href="e4-doc-week-attendance-monitoring.jsp">Week Wise</a></li>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Doctors Attendance Monitoring</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Doctors Attendance Monitoring</li>
            ...
            <div class="card p-4">
                ...
                <div class="table-responsive pt-2">
                    <table id="faqs" class="table table-sm table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td rowspan="15" class="border alert alert-success">
                                    P02266 <br> Dr. Dravid
                                </td>
                                <tr>
                                    <td colspan="3" class="bg-primary text-white border text-center">Monday</td>
                                    <td colspan="3" class="bg-success text-white border text-center">Tuesday</td>
                                    <td colspan="3" class="bg-danger text-white border text-center">Wednesday</td>
                                    <td colspan="3" class="bg-info text-white border text-center">Thursaday</td>
                                    <td colspan="3" class="bg-warning text-white border text-center">Friday</td>
                                    <td colspan="3" class="bg-dark text-white border text-center">Saturday</td>
                                    <td colspan="3" class="bg-secondary text-white border text-center">Sunday</td>
                                </tr>
                                <tr>
                                    <td><b>Location</b></td>
                                    <td><b> <span class="text-danger">Login</span></b></td>
                                    <td><b> <span class="text-danger">Logout</span></b></td>
                                    <td><b>Location</b></td>
                                    <td><b> <span class="text-danger">Login</span></b></td>
                                    <td><b> <span class="text-danger">Logout</span></b></td>
                                    <td><b>Location</b></td>
