                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e4-payroll-payslip.jsp"><i class="bi bi-file-earmark-medical"></i>Payslip</a></li> 
                            ...
                            <div class="invoice-top clearfix">
                                ...
                                <div class="">
                                    <div class="clientlogo">
                                        <img src="./assets/images/e4-user.jpg" alt="user" class="rounded-circle img-fluid">
                                    </div>
                                    <div class="info">
                                        <h6>Rajasekhar</h6>
