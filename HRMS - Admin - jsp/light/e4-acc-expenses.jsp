                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e4-acc-expenses.jsp"><i class="bi bi-cash-coin"></i>Expenses</a></li>
                        ...
                        <ul class="main-menu metismenu">
                            <li class="">
                                ...
                                <ul> 
                                    ...
                                    <li class=""><a href="e4-leaves-recommend.jsp">Leaves to Recommend</a></li>
                        ...
                        <form action="">
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <div class="pb-4">
                                        <textarea class="form-control" placeholder="Claim for" name="" id="subject" cols="10" rows="3" required></textarea>
                                    </div>
                                    <div class="pb-4">
