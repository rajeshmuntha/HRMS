...
<html lang="en">
<head>
<title>SPTECHHUB | Leave Approve</title>
<meta charset="utf-8">
                        ...
                        <ul class="main-menu metismenu">
                            <li class="active">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="e4-leaves-approve.jsp">Leave's to Approve</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Leave's to Approve</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Leave's to Approve</li>
                        </ul>
                    </div>            
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header float-right">
                            ...
                            <button type="button" class="btn btn-sm btn-success px-3" title="Approved">Approve</button>
                            <button type="button" class="btn btn-sm btn-outline-danger" title="Declined" data-type="confirm">Reject</button>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom m-b-0 c_list">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <textarea maxlength="40" cols="20" rows="3"></textarea>
                                            </td>
