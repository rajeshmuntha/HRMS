                ...
                <div class="tab-pane animated fadeIn active" id="project_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            <li class="active"><a href="e1-app-inbox.jsp"><i class="icon-envelope"></i>Inbox App</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Compose Email</h2>
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="e1-app-inbox.jsp">Inbox</a></li>
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="m-t-30">
                                ...
                                <a href="e1-app-inbox.jsp" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
