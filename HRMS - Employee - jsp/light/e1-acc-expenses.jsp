...
<html lang="en">
<head>
<title>SPTECHHUB | Claim Expenses</title>
<meta charset="utf-8">
                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e1-acc-expenses.jsp"><i class="bi bi-cash-coin"></i>Expenses</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="e1-page-profile2.jsp"><i class="icon-home"></i></a></li>                            
                                ...
                                <table class="table table-hover ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Pending</td>
                                            <td class="text-wrap" style="width: 8rem;">Pending for Approval.</td>
                                        </tr>
                                    </tbody>
                                </table>
