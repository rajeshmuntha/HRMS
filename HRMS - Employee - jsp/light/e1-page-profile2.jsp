            ...
            <div class="navbar-right">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">                  
                        <li><a href="e1-app-events.jsp" class="icon-menu d-none d-sm-block d-md-none d-lg-block text-decoration-none"><i class="icon-calendar"></i></a></li>
                        <li><a href="e1-app-chat.jsp" class="icon-menu d-none d-sm-block text-decoration-none"><i class="icon-bubbles"></i></a></li>
                        <li><a href="e1-app-inbox.jsp" class="icon-menu d-none d-sm-block text-decoration-none"><i class="icon-envelope"></i><span class="notification-dot"></span></a></li>
                        <li class="dropdown">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu user-menu menu-icon animated bounceIn text-decoration-none">
                                ...
                                <li><a href="e1-page-login.jsp"><i class="bi bi-file-lock2"></i> <span>Lock Your Screen</span></a></li>
                            </ul>
                        </li>
                        <li><a href="e1-page-lockscreen.jsp" class="icon-menu"><i class="icon-login"></i></a></li>                        
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <div class="dropdown">
                    <span>Welcome,</span>
                    <a href="javascript:void(0);" class="dropdown-toggle user-name text-decoration-none" data-toggle="dropdown"><strong>Rajesh Muntha</strong></a>                    
                    <ul class="dropdown-menu dropdown-menu-right account animated flipInY">
                        <li class="text-decoration-none"><a href="e1-page-profile2.jsp"><i class="icon-user"></i>My Profile</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Employee Profile</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card profile-header">
                        <div class="body">
                            <div class="profile-image"> <img src="../assets/images/e1-user.jpeg" class="w-75 rounded-circle shadow img-fluid alt=""> </div>
                            <div>
                                <h4 class="m-b-0"><strong>Rajesh</strong> Muntha</h4>
                                <span class="fw-bold">UI Developer</span> <br>
                                <span>Andhra Pradesh.</span>
                            </div>
                            <div class="m-t-15">
                                <button class="btn btn-primary px-4">Follow</button>
                                <a href="e1-app-chat.jsp"><button class="btn btn-outline-secondary">Message</button></a>
                            </div>                            
                        </div>
                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    ...
                                                                    <input type="text" class="form-control" value="Rajesh" disabled placeholder="First Name">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-group">   
                                                                    ...
                                                                    <input type="text" class="form-control" value="muntharajesh6" disabled placeholder="Username">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group">  
                                                                    <label for="">Email ID</label>                                              
                                                                    <input type="email" class="form-control" value="muntharajesh6@gmail.com" disabled placeholder="Email id">
                                                                </div>
                                                            </div>
                                                            <div class="col-6">
                                                                <div class="form-group"> 
                                                  ...
                                                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                                    ...
                                                    <div class="">
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-12">
                                                                ...
                                                                <div class="form-group py-2">   
                                                                    <input type="text" class="form-control" placeholder="Identification Marks 1" pattern="[A-Z]*[a-z]*">
                                                                </div>
                                                                <div class="form-group">                
                                                                    <input type="text" class="form-control" placeholder="Identification Marks 2" pattern="[A-Z]*[a-z]*">
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-12">
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" placeholder="Name as in ID Proof" pattern="[A-Z]*[a-z]*">
                                                              </div>
                                                              <div class="form-group py-2">
                                                                  <input type="text" class="form-control" placeholder="Number in ID Proof">
                                                              </div>
                                                              <div class="form-group">                  
                                                                  <input type="text" class="form-control" placeholder="Father Name" pattern="[A-Z]*[a-z]*">
                                                              </div>
                                                              <div class="form-group py-2">                                                    <input type="text" class="form-control" placeholder="Mother Name" pattern="[A-Z]*[a-z]*">
                                                              </div>                                                     
                                                              <div class="form-group">
                                                                <input id="gfg_field1" 
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-12">
                                                                <form name=f1 method=post enctype="multipart/form-data">
                                                                    ...
                                                                    <input class="form-group" id="uploadPDF7" type="file" name="file"accept=".pdf"/> 
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-sm-6 col-12">
                                                                ...
                                                                <div id="toast" class="text-primary">
                                                                    <img width="50px" class="pb-2" src="../assets/images/check-circle.gif" alt="" srcset=""> <br>
