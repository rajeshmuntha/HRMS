                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="e1-emp-leave.jsp"><i class="bi bi-pencil-square"></i>Apply Leave</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Apply Leave</h2>
                        <ul class="breadcrumb">
                                ...
                                <table class="table table-hover table-sm">
                                    <thead class="bg-primary text-white">
                                        <tr class="text-center">
                                            ...
                                            <th style="vertical-align: middle;">From Date</th>
                                            <th style="vertical-align: middle;">To Date</th>
                                            <th style="vertical-align: middle;" class="text-center">Reason</th>
                                            <th style="vertical-align: middle;">Contact on Leave</th>
                                            <th style="vertical-align: middle;">Status</th>
                                            <th style="vertical-align: middle;">Select & <br> Withdraw</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr class="text-center">
