                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            <li class="active"><a href="d2-emp-attendance2.jsp"><i class="bi bi-book"></i>Attendance</a></li>
                            <li class="">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Doctor Attendance</li>
                        </ul>
                    </div>            
                        ...
                        <div class="card-body">
                            ...
                            <div class="p-2" style="height: 365px;">
                                ...
                                <div class="card p-2 mb-3 mt-0 pt-0 border">
                                    ...
                                    <div class="progress mt-3" style="height: 3px;">
                                        <div id="myprogressBar2" class="progress-bar bg-warning" role="progressbar" style="width: 65%" aria-valuenow="31" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="card p-2 mb-3 mt-0 pt-0 border">
                                    <span>This Month <strong>80 <small>/ 160 hrs</small></strong></span>
                                    <div class="progress mt-3" style="height: 3px;">
                                        <div id="myprogressBar3" class="progress-bar bg-success" role="progressbar" style="width: 52%" aria-valuenow="52" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                                <div class="card p-2 mb-3 mt-0 pt-0 border">
                                    <span>Remaining <strong>80 <small>/ 160 hrs</small></strong></span>
                                    <div class="progress mt-3" style="height: 3px;">
                                        <div id="myprogressBar4" class="progress-bar bg-danger" role="progressbar" style="width: 52%" aria-valuenow="52" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
