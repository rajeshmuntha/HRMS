                    ...
                    <ul class="nav navbar-nav">                        
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu user-menu menu-icon animated bounceIn">
                                ...
                                <li><a href="d2-page-login.jsp"><i class="bi bi-file-lock2"></i> <span>Lock Your Screen</span></a></li>
                            </ul>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="d2-app-inbox.jsp">Inbox</a></li>
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="m-t-30">
                                ...
                                <a href="d2-app-inbox.jsp" class="btn btn-outline-secondary">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
