...
<html lang="en">
<head>
<title>SPTECHHUB | Doctor Week Roster</title>
<meta charset="utf-8">
                    ...
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    <li class="active"><a style="padding-left: 78px;" href="d2-view-week-roster.jsp">Week Wise</a></li>
                                    <li class=""><a style="padding-left: 78px;" href="d2-view-month-roster.jsp">Month Wise</a></li>
                                </ul>                                
                            </li>
