...
<html lang="en">
<head>
<title>SPTECHHUB | Expenses</title>
<meta charset="utf-8">
...
<body class="theme-blue" oncontextmenu="return false;"  onload="onload()">
                ...
                <div class="tab-pane animated fadeIn flow active" id="hr_menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu pb-4">
                            ...
                            <li class="active"><a href="d2-acc-expenses.jsp"><i class="bi bi-cash-coin"></i>Expenses</a></li>
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Claim Expenses</h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="d2-page-profile2.jsp"><i class="icon-home"></i></a></li>                            
                                ...
                                <table class="table table-hover ">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Pending</td>
                                            <td class="text-wrap" style="width: 8rem;"></td>
                                        </tr>
                                    </tbody>
                                </table>
...
<!-- Default Size -->
<div class="modal fade" id="Exp_Request" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="title" id="defaultModalLabel">Add your Expenses</h6>
                    ...
                    <div class="pb-3">
                        <form action="">
                            <div class="row">
                                <div class="col-6">
                                    <div class="pb-4">
                                        <input id="date" data-provide="datepicker" data-date-autoclose="true" class="form-control" placeholder="Claim Date" data-date-format="dd-mm-yyyy" required>
                                    </div>
                                    <div class="pb-4">
                                        <textarea class="form-control" placeholder="Claim for" name="" id="subject" cols="10" rows="3" maxlength="40" required></textarea>
                                    </div>
                                    <div class="pb-4">
                                        <input class="form-control" type="text" name="" id="amount" placeholder="Enter Amount" required>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <form name= method= enctype="">
                                        <label for="">Upload <span class="text-danger">in Image:</span></label>
                                        <input class="form-group" id="uploadPDF" type="file" name="file"/ required> <br>
                                ...
                                <div class="col-lg-12 pt-3">
                                    <div class="row">
                                        <div class="col-6">
                                            <button type="button" class="btn btn-primary btn-block add-row" value="Add Row" data-dismiss="modal">Submit</button>
                                        </div>
                                        <div class="col-6">
